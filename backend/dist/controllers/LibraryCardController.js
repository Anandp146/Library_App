...
const LibraryCard_1 = require("../services/LibraryCard");
const libraryErrors_1 = require("../utils/libraryErrors");
function getLibraryCard(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const { cardId } = req.params;
        try {
            let libraryCard = yield (0, LibraryCard_1.findLibraryCard)(cardId);
...
function createLibraryCard(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const card = req.body;
        try {
            let libraryCard = yield (0, LibraryCard_1.registerLibraryCard)(card);
            res
                .status(201)
